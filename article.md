...
- **Application des groupes de Lie à la recherche des symétries des tissus implicites du plan**, avec Jacky Cresson. Versions [Arxiv](https://arxiv.org/pdf/2310.04093.pdf) [HAL](https://hal.science/hal-04228995v1/document)
  Publié dans Annales mathématiques Blaise Pascal, Volume 31 (2024) p. 65-82, et consultable [ici](https://ambp.centre-mersenne.org/articles/10.5802/ambp.426/)
...
- **Asynchronous layerwise deep learning with MCMC on low-power devices** Version [HAL](https://hal.science/hal-04270262v1/document), avec M.François, P.Gay, S.Lebeaud, S.Loustau, F.K.Sow, N.Tirel.
  Publié dans ESAIM: ProcS, Volume 80, 2025, Journées MAS 2022 - Dynamic and Stochastic Modelling consultable [ici](https://www.esaim-proc.org/articles/proc/abs/2025/03/proc20258006/proc20258006.html)
...
## Pré-publications
- **Variance of vector fields - Definitions and Properties**, avec Jacky Cresson, 20 p., 2026.
